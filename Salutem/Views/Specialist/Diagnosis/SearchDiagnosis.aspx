<%@ Page Title="" Language="C#" MasterPageFile="~/Salutem.Master" AutoEventWireup="true" CodeBehind="SearchDiagnosis.aspx.cs" Inherits="Salutem.Views.Specialist.Diagnosis.SearchDiagnosis1" %>
        ...
        $(document).ready(function () {
            ...
            .done(function (resp) {
                ...
                for (var i = 0; i < appointment.aaData.length; i++) {
                    ...
                    identityCard = appointment.aaData[i].identityCardidentityCard;
