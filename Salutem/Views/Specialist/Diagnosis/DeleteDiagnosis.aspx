<%@ Page Title="" Language="C#" MasterPageFile="~/Salutem.Master" AutoEventWireup="true" CodeBehind="DeleteDiagnosis.aspx.cs" Inherits="Salutem.Views.Specialist.Diagnosis.DeleteDiagnosis" %>
            ...
            <div class="col-lg-8 borderRounded">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtHour" runat="server" ReadOnly="true" class="form-control" placeholder="Hora de la cita"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <asp:Label ID="lblDescripcion" runat="server" Text="Descripción"></asp:Label>
                        <asp:TextBox ID="txtDescripcion" runat="server" ReadOnly="true" CssClass="form-control" placeholder="Descripción" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    ...
                    <asp:Button ID="btnEliminarDiagnostico" runat="server" CssClass="btn btn-danger" Text="Eliminar" OnClick="btnEliminarDiagnostico_Click"/> &nbsp;
                    <br>
                    <br>
                </form>
            </div>
