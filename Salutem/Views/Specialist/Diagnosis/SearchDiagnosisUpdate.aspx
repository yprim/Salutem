<%@ Page Title="" Language="C#" MasterPageFile="~/Salutem.Master" AutoEventWireup="true" CodeBehind="SearchDiagnosisUpdate.aspx.cs" Inherits="Salutem.Views.Specialist.Diagnosis.SearchDiagnosis" %>
            ...
            .done(function (resp) {
                ...
                for (var i = 0; i < appointment.aaData.length; i++) {
                    ...
                    table +=
                        ...
                        "<td> <a href='UpdateDiagnosis.aspx?id=" + id + "&name=" + name + "&identityCard=" + identityCard + "&date=" + date + "&hour=" + hour +"&status=" + status + "&description=" + description + "'>Actualizar </a> </td>" +
                        "</tr>";
                }
