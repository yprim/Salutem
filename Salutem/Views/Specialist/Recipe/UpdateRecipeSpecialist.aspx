<%@ Page Title="" Language="C#" MasterPageFile="~/Salutem.Master" AutoEventWireup="true" CodeBehind="UpdateRecipeSpecialist.aspx.cs" Inherits="Salutem.Views.Specialist.Recipe.UpdateRecipeSpecialist" %>
            ...
            <div class="col-lg-8 borderRounded">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtActualHour" runat="server" CssClass="form-control" placeholder="Hora"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <asp:Label ID="lblDescripcion" runat="server" Text="Descripción"></asp:Label>
                        <asp:TextBox ID="txtDescripcion" runat="server" CssClass="form-control" placeholder="Nueva descripción" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    ...
                    <asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-danger" Text="Actualizar" OnClick="btnUpdate_Click"/>
                    <br>
                    <br>
                </form>
            </div>
